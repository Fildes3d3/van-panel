...
static void build_ui()
{
    ...
    lbl_summary = make_label(scr, &lv_font_montserrat_16, lv_color_white());
    ...
    lv_obj_align(lbl_summary, LV_ALIGN_TOP_LEFT, 40, 218);

    lbl_diag = make_label(scr, &lv_font_montserrat_16, grey);
    lv_label_set_text(lbl_diag, "Idle diagnostics: --");
    lv_obj_align(lbl_diag, LV_ALIGN_TOP_LEFT, 40, 400);
