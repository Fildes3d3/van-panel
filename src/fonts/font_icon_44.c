 ...
 * Size: 44 px
 * Bpp: 4
 * Opts: --font .pio/libdeps/ws43b/lvgl/scripts/built_in_font/FontAwesome5-Solid+Brands+Regular.woff -r 0xf242,0xf043 --size 44 --bpp 4 --format lvgl --no-compress --lv-include lvgl.h -o src/fonts/font_icon_44.c
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 0, .adv_w = 484, .box_w = 31, .box_h = 45, .ofs_x = 0, .ofs_y = -6},
    {.bitmap_index = 698, .adv_w = 880, .box_w = 55, .box_h = 29, .ofs_x = 0, .ofs_y = 2}
};
...
{
    {
        .range_start = 61507, .range_length = 512, .glyph_id_start = 1,
...
#if LV_VERSION_CHECK(8, 0, 0)
const lv_font_t font_icon_44 = {
#else
lv_font_t font_icon_44 = {
#endif
