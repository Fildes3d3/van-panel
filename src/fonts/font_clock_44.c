 ...
 * Size: 44 px
 * Bpp: 4
 * Opts: --font .pio/libdeps/ws43b/lvgl/scripts/built_in_font/Montserrat-Medium.ttf --symbols 0123456789:-  --size 44 --bpp 4 --format lvgl --no-compress --lv-include lvgl.h -o src/fonts/font_clock_44.c
 ******************************************************************************/
...
#ifndef FONT_CLOCK_44
#define FONT_CLOCK_44 1
#endif
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 0, .adv_w = 270, .box_w = 13, .box_h = 4, .ofs_x = 2, .ofs_y = 10},
    {.bitmap_index = 26, .adv_w = 470, .box_w = 26, .box_h = 31, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 429, .adv_w = 260, .box_w = 12, .box_h = 31, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 615, .adv_w = 404, .box_w = 24, .box_h = 31, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 987, .adv_w = 403, .box_w = 24, .box_h = 31, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 1359, .adv_w = 471, .box_w = 28, .box_h = 31, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 1793, .adv_w = 404, .box_w = 24, .box_h = 31, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 2165, .adv_w = 434, .box_w = 24, .box_h = 31, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 2537, .adv_w = 421, .box_w = 24, .box_h = 31, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 2909, .adv_w = 453, .box_w = 26, .box_h = 31, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 3312, .adv_w = 434, .box_w = 25, .box_h = 31, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 3700, .adv_w = 160, .box_w = 6, .box_h = 24, .ofs_x = 2, .ofs_y = 0}
};
...
#if LV_VERSION_CHECK(8, 0, 0)
const lv_font_t font_clock_44 = {
#else
lv_font_t font_clock_44 = {
#endif
