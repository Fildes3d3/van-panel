 ...
 */
// Globebus: draw buffers moved to PSRAM (2026-09-22) - in internal SRAM they took 64 KB and left too little for
// Wi-Fi WPA2/TLS (esp-sha/esp-aes need internal DMA memory) and Bluetooth. Original line kept for reference:
